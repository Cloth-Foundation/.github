# Cloth — Security Policy

## Supported Versions

The Cloth Foundation currently supports the latest stable release of the Cloth compiler and standard library. Older versions may receive security patches at the discretion of the Cloth.
